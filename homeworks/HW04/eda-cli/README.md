...
## Доработки в рамках выполнения дз 4

### Реализован эндпоинт `POST /quality-flags-from-csv`, который возвращает флаги качества датасета в формате json

Запрос принимает CSV-файл и возвращает булевы флаги (результаты работы эвристик) качества датасета.
